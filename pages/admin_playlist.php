          ...
          <table class="table table-dark table-hover">
            ...
            <tbody>
              ...
              <?php while($row = $results->fetch_assoc()) {?>
                ...
                <?php $counter++;?>
                <td><span id="creator_first_name<?php echo $row["ID"];?>"> <?php echo $row["creator_first_name"];?></span></td>
                <td><span id="creator_last_name<?php echo $row["ID"];?>"> <?php echo $row["creator_last_name"];?></span></td>
