...
$sql = "SELECT * from ratings_info_view WHERE rating_id =" . $_REQUEST["ratingid"];
...
<div class = "main-body center">
    <div class="column">
        <div class="column-content">
            ...
            <form action="update_ratings.php">
                <h1>Edit Rating</h1>

                <input type="hidden" name="ratingid" value="<?php echo $recorddata["rating_id"];?>">
                Comment:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input style="width: 600px; height: 50px;"type="text" name="comment" value="<?php echo $recorddata["comment"];?>"><br>
                ...
                <input name="rating" style="width: 100px;"type="number" min="1" max="5" name="rating" value="<?php echo $recorddata["rating"] ?>">
                <br>
