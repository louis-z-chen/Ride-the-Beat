...
<body>
  ...
  <div class = "main-body center">
    <div class="column">
          ...
          <table class="table table-dark table-hover">
            ...
            <tbody>
              ...
              <?php while($row = $results->fetch_assoc()) {?>
                ...
                <td><span id="rating<?php echo $row["ID"];?>"> <?php echo $row["rating"];?></span></td>
                ...
                <td align="center">
                  <button type="button"class="btn btn-outline-warning edit editbutton" value="<?php echo $row['rater_id']; ?>"><i class="far fa-edit"></i>
                      <a style="text-decoration: none; color: inherit;" href = "edit_rating.php?id=<?php echo $row['rater_id'];?>" >Edit</a>
      ...
      <div class="hidden">
        <form method="POST" action="admin_ratingOLD.php" id="hidden_form">
